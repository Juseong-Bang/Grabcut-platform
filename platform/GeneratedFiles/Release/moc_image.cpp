...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CImage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 46, 3)
    ...
    "CImage\0selectLayer\0\0nLayerIdx\0"
...
void CImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->selectLayer((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject CImage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CImage.data,
      qt_meta_data_CImage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CImage.stringdata))
